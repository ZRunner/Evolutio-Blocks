...
?>
            <p>
                ...
                ?>
                    ...
                    ?>
                        <textarea id="<?php echo $esc_key; ?>" name="<?php echo $esc_key; ?>" placeholder="<?php echo $placeholder ?>" rows="5" cols="60" maxlength="<?php echo $max_size; ?>" required><?php echo esc_textarea($value); ?></textarea>
                    <?php
                        break;
                    case FieldType::PHONE:
                    ?>
                        <input type="tel" id="<?php echo $esc_key; ?>" name="<?php echo $esc_key; ?>" value="<?php echo $esc_value; ?>" placeholder="<?php echo $placeholder; ?>" size="30" maxlength="20" required />
                    <?php
                        break;
                    case FieldType::EMAIL:
                    ?>
                        <input type="email" id="<?php echo $esc_key; ?>" name="<?php echo $esc_key; ?>" value="<?php echo $esc_value; ?>" placeholder="<?php echo $placeholder; ?>" size="60" maxlength="<?php echo $max_size ?>" required />
                    <?php
                        break;
                    default:
                    ?>
                        <input type="text" id="<?php echo $esc_key; ?>" name="<?php echo $esc_key; ?>" value="<?php echo $esc_value; ?>" placeholder="<?php echo $placeholder; ?>" size="60" maxlength="<?php echo $max_size ?>" required />
    <?php
                }
                echo '</p>';
            }
